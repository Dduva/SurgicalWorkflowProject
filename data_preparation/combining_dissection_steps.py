...
def main():
    ...
    for pkl_file in pkl_files:
        ...
        """
        # TODO: map the labels as follows:
        tumour debulking: 0->0
        dissection_medial: 1 -> 1
        dissection_inferior: 2 -> 1
        dissection_superior: 3 -> 1
        dissection_lateral: 4 -> 1
        """
        mapping = {
            0: 0,
            1: 1,
        ...
        new_train_labels = [mapping[value] for value in train_labels]
        new_val_labels = [mapping[value] for value in val_labels]
        new_test_labels = [mapping[value] for value in test_labels]
        ...
        data[2] = new_train_labels
        data[3] = new_val_labels
        data[7] = new_test_labels
        ...
        with open(os.path.join(OVERALL_PATH, pkl_file + '_combined_steps_eartype_info.pkl'), 'wb') as f:
            pickle.dump(data, f)
